...
const baTable = new baTableClass(
    new baTableApi('/admin/payconfig.PayChannel/'),
    {
        ...
        column: [
            ...
            { label: t('payconfig.payChannel.pay_api_id'), prop: 'pay_api_id', align: 'center', operatorPlaceholder: t('Fuzzy query'), operator: 'LIKE' },
            ...
            { label: t('payconfig.payChannel.mashang_channels_id'), prop: 'mashang_channels_id', align: 'center', operator: false },
            ...
            { label: t('payconfig.payChannel.sys_rate'), prop: 'sys_rate', align: 'center', operator: 'RANGE', sortable: false },
            { label: t('payconfig.payChannel.channel_rate'), prop: 'channel_rate', align: 'center', operator: 'RANGE', sortable: false },
