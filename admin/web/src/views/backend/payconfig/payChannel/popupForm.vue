        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    ...
                    <FormItem :label="t('payconfig.payChannel.sys_rate')" type="number" prop="sys_rate" :input-attr="{ step: 1 }" v-model.number="baTable.form.items!.sys_rate" :placeholder="t('Please input field', { field: t('payconfig.payChannel.sys_rate') })" />
                    <FormItem :label="t('payconfig.payChannel.channel_rate')" type="number" prop="channel_rate" :input-attr="{ step: 1 }" v-model.number="baTable.form.items!.channel_rate" :placeholder="t('Please input field', { field: t('payconfig.payChannel.channel_rate') })" />
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    ...
    sys_rate: [buildValidatorData({ name: 'required', title: t('payconfig.payChannel.sys_rate'), message: '系统费率，百分比' })],
    channel_rate: [buildValidatorData({ name: 'required', title: t('payconfig.payChannel.channel_rate'), message: '通道费率，百分比' })],
