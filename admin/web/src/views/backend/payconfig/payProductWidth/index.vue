<template>
    <div class="default-main ba-table-box">
        ...
        >
            <el-tag type="success" class="tap_" v-if="route.query.name">昵称：{{ route.query.name }} - ID：{{ route.query.id }}</el-tag>
        </TableHeader>
...
const baTable = new baTableClass(
    new baTableApi('/admin/payconfig.PayProductWidth/'),
    {
        ...
        column: [
            ...
            {
                label: t('payconfig.payProductWidth.pay_product__name'),
                prop: 'payProduct.name',
                align: 'center',
            ...
            {
                label: t('payconfig.payProductWidth.pay_channel__name'),
            ...
            {
                label: t('payconfig.payProductWidth.switch'),
                prop: 'switch',
                align: 'center',
                render: 'switch',
                operator: '=',
                sortable: false,
                replaceValue: { 0: t('payconfig.payProductWidth.switch 0'), 1: t('payconfig.payProductWidth.switch 1') },
            },
